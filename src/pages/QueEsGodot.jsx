export default function QueEsGodot() {
  return (
    <div className="container py-5">
      <h1 className="fw-bold mb-4">¿Qué es Godot?</h1>
      ...
      <p className="mt-4">En CodeGodot te damos fragmentos listos para usar y una guía para integrarlos rápido en tu proyecto.</p>
    </div>
  )
}
